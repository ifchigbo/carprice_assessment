    ...
    try:
        ...
        while True:
            ...
            if unique_bodychoice == 0:
                ...
                price_body = cardataset[[df_header[0],df_header[1],df_header[4],df_header[19]]].loc[cardataset[df_header[4]] == unique_body_type[0]]
                print(price_body.sort_values(by=cols[-1], ascending = False).head(5).reset_index())
            elif unique_bodychoice == 2:
                price_body = cardataset[[df_header[0],df_header[1],df_header[4],df_header[19]]].loc[cardataset[df_header[4]] == unique_body_type[1]]
                print(price_body.sort_values(by=cols[-1], ascending = False).head(5).reset_index())
            elif unique_bodychoice == 3:
                price_body = cardataset[[df_header[0],df_header[1],df_header[4],df_header[19]]].loc[cardataset[df_header[4]] == unique_body_type[2]]
                print(price_body.sort_values(by=cols[-1], ascending = False).head(5).reset_index())
            elif unique_bodychoice == 4:
                price_body = cardataset[[df_header[0],df_header[1],df_header[4],df_header[19]]].loc[cardataset[df_header[4]] == unique_body_type[3]]
                print(price_body.sort_values(by=cols[-1], ascending = False).head(5).reset_index())
            elif unique_bodychoice == 5:
                price_body = cardataset[[df_header[0],df_header[1],df_header[4],df_header[19]]].loc[cardataset[df_header[4]] == unique_body_type[4]]
                print(price_body.sort_values(by=cols[-1], ascending = False).head(5).reset_index())
            else:
                print(" ")
