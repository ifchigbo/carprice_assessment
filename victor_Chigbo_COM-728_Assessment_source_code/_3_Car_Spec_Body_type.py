...
def retrieveCarsBody(cardf):
    try:
        ...
        while True: # creating a tui within the master tui module
            ...
            if bodychoice == 1:
                print(cardf.loc[cardf[df_header[4]]== car_body_type[0]][[df_header[1],df_header[4],df_header[13],df_header[19]]])
            elif bodychoice == 2:
                print(cardf.loc[cardf[df_header[4]]== car_body_type[1]][[df_header[1],df_header[4],df_header[13],df_header[19]]])
            elif bodychoice == 3:
                print(cardf.loc[cardf[df_header[4]]== car_body_type[2]][[df_header[1],df_header[4],df_header[13],df_header[19]]])
            elif bodychoice == 4:
                print(cardf.loc[cardf[df_header[4]]== car_body_type[3]][[df_header[1],df_header[4],df_header[13],df_header[19]]])
            elif bodychoice == 5:
                print(cardf.loc[cardf[df_header[4]]== car_body_type[4]][[df_header[1],df_header[4],df_header[13],df_header[19]]])
            elif bodychoice == 0:
                break
            else:
